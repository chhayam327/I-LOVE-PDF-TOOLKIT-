...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      { title: "Log in — I Love PDF TOOLKIT" },
      { name: "description", content: "Log in to access your PDF tools, history and premium features." },
    ],
  }),
});
      ...
      <main className="mx-auto max-w-md px-4 pt-10">
        <div className="glass shadow-float rounded-3xl p-8">
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <h1 className="mt-4 text-2xl font-extrabold text-secondary">Welcome back</h1>
            <p className="mt-1 text-sm text-muted-foreground">Log in to continue to PDF Toolkit</p>
          </div>
          ...
          <p className="mt-5 text-center text-sm text-muted-foreground">
            New here? <Link to={"/signup" as "/"} className="font-semibold text-primary hover:underline">Create an account</Link>
          </p>
        </div>
      </main>
    </PageShell>
